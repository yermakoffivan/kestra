 ...
 * without killing the whole execution — unlike {@link ExecutionKilledExecution}, which is
 * execution-scoped end to end (cached and matched by {@code executionId} alone), this only affects
 * the task runs listed in {@link #taskRunIds}, landing them in {@link #taskRunState} instead of
 * {@code KILLED}.
 */
@Getter
@SuperBuilder
